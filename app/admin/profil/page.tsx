...
const sizeOptions: ProfileForm['kleidergroesse_tshirt'][] = ['XS', 'S', 'M', 'L', 'XL', '2XL', '3XL'];
  ...
  useEffect(() => {
    async function loadProfile() {
      ...
      setForm({
        ...
        plz: data?.plz ?? '',
        ort: data?.ort ?? '',
        kleidergroesse_tshirt: (data?.kleidergroesse_tshirt as ProfileForm['kleidergroesse_tshirt']) ?? 'M',
        kleidergroesse_jacke: (data?.kleidergroesse_jacke as ProfileForm['kleidergroesse_jacke']) ?? 'M',
  ...
  return (
    <section className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
      <div className="mb-5">
        ...
        <p className="mt-1 text-sm text-slate-600">Hier kannst du deine persönlichen Daten bearbeiten.</p>
      </div>
        ...
        <form onSubmit={onSubmit} className="grid gap-4">
          ...
          <div className="grid gap-3 md:grid-cols-3">
            <select
              ...
              onChange={(e) => setForm((prev) => ({ ...prev, kleidergroesse_tshirt: e.target.value as ProfileForm['kleidergroesse_tshirt'] }))}
            >
            ...
            <select
              ...
              onChange={(e) => setForm((prev) => ({ ...prev, kleidergroesse_jacke: e.target.value as ProfileForm['kleidergroesse_jacke'] }))}
            >
              {sizeOptions.map((size) => (
                <option key={size} value={size}>
                  Jacke: {size}
